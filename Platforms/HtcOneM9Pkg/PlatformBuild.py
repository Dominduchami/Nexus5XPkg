# @file
# Script to Build HtcOneM9 Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("HtcOneM9Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('HtcOneM9', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("HtcOneM9Pkg/HtcOneM9.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "HtcOneM9", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "HtcOneM9Pkg/HtcOneM9.dsc", "Platform Hardcoded")
