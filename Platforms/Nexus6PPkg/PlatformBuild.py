# @file
# Script to Build Nexus 6P UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("Nexus6PPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Nexus6P', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "Nexus6PPkg/Nexus6P.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Nexus6P", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "Nexus6PPkg/Nexus6P.dsc", "Platform Hardcoded")
