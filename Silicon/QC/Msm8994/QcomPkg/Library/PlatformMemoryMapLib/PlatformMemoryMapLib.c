...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    {"Display Reserved",  0x03401000, 0x02200000, AddMem, MEM_RES, WRITE_THROUGH, MaxMem, WRITE_THROUGH},
    {"HLOS 2",            0x04601000, 0x001FF000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK},
    {"TZ App Mem",        0x04800000, 0x01900000, AddMem, SYS_MEM, SYS_MEM_CAP,  Reserv, NS_DEVICE},
    {"HLOS 3",            0x06100000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK},
    /* memory hole start (0x6300000, 0xd00000)
    {"Removed Region 1",  0x06300000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP,  Reserv, NS_DEVICE},*/
#endif
#if SILICON_PLATFORM == 8992
    ...
    Reserved regions, marked as remove_completely downstream : 
    modem region, reg = <0x00 0x7000000 0x00 0x5a00000>;
    periph region, reg = <0x00 0xca00000 0x00 0x1f00000>;*/
    {"Reserved mem",      0x0E900000, 0x00600000, AddMem, SYS_MEM, SYS_MEM_CAP,  Reserv, NS_DEVICE},
    {"CNSS_DEBUG",        0x0EF00000, 0x00300000, AddMem, SYS_MEM, SYS_MEM_CAP,  Reserv, NS_DEVICE},
    {"HLOS 3",            0x0F200000, 0x10C00000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK},
    /* ramoops_region, reg = <0x00 0x1fe00000 0x00 0x200000>;*/
#endif
